...
- [Mapping OSM Tags to a Fixed Schema with YAML](https://www.osm-data-processing.org/parsing-tag-normalization-workflows/batch-attribute-mapping-strategies/mapping-osm-tags-to-a-fixed-schema-with-yaml/) — moving the mapping out of code into a file that can be reviewed and diffed.
- [Validating an OSM Tag Mapping Config with Pydantic](https://www.osm-data-processing.org/parsing-tag-normalization-workflows/batch-attribute-mapping-strategies/validating-an-osm-tag-mapping-config-with-pydantic/) — catching shadowed rules and tied priorities before the mapping runs on a continent.

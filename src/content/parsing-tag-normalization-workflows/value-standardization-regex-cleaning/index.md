...
- [Cleaning OSM Website and Contact URL Tags](https://www.osm-data-processing.org/parsing-tag-normalization-workflows/value-standardization-regex-cleaning/cleaning-osm-website-and-contact-url-tags/) — normalising the schemes, duplicates and free text that real contact tags contain.
- [Normalizing OSM Phone Numbers to E.164](https://www.osm-data-processing.org/parsing-tag-normalization-workflows/value-standardization-regex-cleaning/normalizing-osm-phone-numbers-to-e164/) — turning locally formatted numbers into a form a dialler will accept.
- [Normalizing OSM Speed Limits and Units](https://www.osm-data-processing.org/parsing-tag-normalization-workflows/value-standardization-regex-cleaning/normalizing-osm-speed-limits-and-units/) — parsing maxspeed values, implicit zone defaults and the units that are not stated.

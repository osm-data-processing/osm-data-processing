...
- [Exporting an OSMnx Graph to GeoPackage](https://www.osm-data-processing.org/parsing-tag-normalization-workflows/osmnx-graph-conversion-techniques/exporting-an-osmnx-graph-to-geopackage/) — writing nodes and edges to a format other tools can open without your code.
- [Simplifying an OSMnx Graph Without Losing Geometry](https://www.osm-data-processing.org/parsing-tag-normalization-workflows/osmnx-graph-conversion-techniques/simplifying-an-osmnx-graph-without-losing-geometry/) — contracting intermediate nodes while keeping the shape of the road.
